...
fn parse() {
    ...
    assert_eq!(descriptor.block_bitmap_block(), FsBlockNumber(0xe));
    assert_eq!(descriptor.inode_bitmap_block(), FsBlockNumber(0x1e));
    assert_eq!(descriptor.inode_table_block(), FsBlockNumber(0x2e));
    assert_eq!(descriptor.free_block_count(), BlockCount(22954));
    ...
    assert_eq!(descriptor.exclude_bitmap_block(), FsBlockNumber(0));
